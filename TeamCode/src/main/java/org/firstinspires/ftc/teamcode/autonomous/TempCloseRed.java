...
public class TempCloseRed extends OpMode{
    ...
    private final Pose startPose = new Pose(20, 120, Math.toRadians(144)).mirror(); // STARTING POSITION was 23, 124 , 144
    ...
    private final Pose grabRow1 = new Pose(25, 84, Math.toRadians(0)).mirror(); // Position
    ...
    private final Pose grabRow2 = new Pose(21, 60, Math.toRadians(0)).mirror();
