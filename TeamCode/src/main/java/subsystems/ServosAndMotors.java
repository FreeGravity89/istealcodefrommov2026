...
public class ServosAndMotors {
    ...
    //private intakeTIme intakeTIme= new ElapsedTime();
    ...
    private double FlipperTimePurp = 0.65;
    private double FlipperTimeGree = 0.25;
    private double shootTime1 = 1.5; //This is adjusing to how long before it shoots
    // ShootConstants
    ...
    public void update(){
        ...
        public void fireshots(int numberofshots){
            if(shootState == ShootState.IdlePPG ||  shootState == ShootState.IdleGPP){
                shotsRemaining = numberofshots;
            }
        }
        public boolean isBusy(){
            return shootState != ShootState.IdlePPG && shootState != ShootState.IdleGPP;
        }
        public void loop() {
